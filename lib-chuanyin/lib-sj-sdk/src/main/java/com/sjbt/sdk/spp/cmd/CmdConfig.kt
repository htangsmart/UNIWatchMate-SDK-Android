...
const val URN_APP_WEATHER_PUSH_ALL: Byte = URN_0
...
const val URN_SPORT_DISTANCE: Byte = URN_4
const val URN_SPORT_OXYGEN: Byte = URN_5
const val URN_SPORT_RATE: Byte = URN_6
const val URN_SPORT_RATE_RECORD: Byte = URN_1
const val URN_SPORT_RATE_REALTIME: Byte = URN_2
const val URN_SPORT_SLEEP: Byte = URN_7
const val URN_SPORT_SUMMARY: Byte = URN_8
const val URN_SPORT_TODAY: Byte = URN_9
