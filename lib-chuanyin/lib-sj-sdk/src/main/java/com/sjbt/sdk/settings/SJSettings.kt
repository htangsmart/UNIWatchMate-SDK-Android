...
class SJSettings(val sjUniWatch: SJUniWatch) : AbWmSettings() {
    ...
    override val settingSedentaryReminder: AbWmSetting<WmSedentaryReminder> = SettingSedentaryReminder(sjUniWatch)
    ...
    override val settingDrinkWater: AbWmSetting<WmSedentaryReminder> = SettingSedentaryReminder(sjUniWatch)
