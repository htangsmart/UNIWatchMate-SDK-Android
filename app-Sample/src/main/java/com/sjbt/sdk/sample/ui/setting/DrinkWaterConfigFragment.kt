...
import com.sjbt.sdk.sample.databinding.FragmentDrinkWaterConfigBinding
...
class DrinkWaterConfigFragment : BaseFragment(R.layout.fragment_drink_water_config),
    ...
    private val viewBind: FragmentDrinkWaterConfigBinding by viewBinding()
...
//                    viewBind.layoutContent.setAllChildEnabled(it)
    ...
    private fun WmSedentaryReminder.saveConfig() {
        applicationScope.launchWithLog {
            UNIWatchMate.wmSettings.settingDrinkWater.set(this@saveConfig).await()
        }
        updateUI()
    }
